        ...
        <div className={'profile-add-hobbies-header-wrapper'}>
          ...
          <div className={'profile-add-hobbies-header__title'}>
            <div className={'profile-add-hobbies-header__title-main'}>
              <span>{t('authorized.profile.add-hobbies.header.state-1.main')}</span>
            </div>
            <div className={'profile-add-hobbies-header__title-secondary'}>
              <span>{t('authorized.profile.add-hobbies.header.state-1.secondary')}</span>
            </div>
          </div>
        </div>
      );
    case 1:
      return (
        <div className={'profile-add-hobbies-header-wrapper'}>
          ...
          <div className={'profile-add-hobbies-header__title'}>
            <div className={'profile-add-hobbies-header__title-main'}>
              <span>{t('authorized.profile.add-hobbies.header.state-2.main')}</span>
            </div>
          </div>
        </div>
      );
