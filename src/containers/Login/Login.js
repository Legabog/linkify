    ...
    <div className="login-wrapper">
      <div className="login">
        <div className="login__signin-block">
          <div className="login__signin-block__logo">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          <div className="login__signin-block__description">
            <h2>{t("unauthorized.login.description.h2")}</h2>
          </div>
          <div className="login__signin-block__description_2">
            <span>{t("unauthorized.login.description.span")}</span>
          </div>
          <div className="login__signin-block__inputs-wrapper">
            <div className="login__signin-block__inputs">
              <div className="login__signin-block__input">
                <input
                  ...
                  id="login-email"
                  ref={emailRef}
                  placeholder={t("unauthorized.login.signin-block.login-input")}
                  value={email}
                  onChange={emailChangeHandler}
                  onFocus={emailFocusHandler}
                  onBlur={emailBlurHandler}
                  style={{
                    borderColor: emailFocus ? "#7FC8FF" : null,
              ...
              <div className="login__signin-block__input">
                <input
                  ...
                  style={{
                    borderColor: passwordFocus ? "#7FC8FF" : null,
          ...
          <div className="login__signin-block__buttons">
            <div
              className="login__signin-block__button-signin"
              onClick={loginButtonSignInHandler}
            >
              <span>{t("unauthorized.login.signin-block.login-button")}</span>
            </div>
            <NavLink to={"/signup"}>
              <div className="login__signin-block__button-signup">
                <span>
