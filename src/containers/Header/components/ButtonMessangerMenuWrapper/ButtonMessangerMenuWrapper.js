...
export const ButtonMessangerMenuWrapper = (props) => {
  ...
  const [value, ref, changeHandler, isFocus, focusHandler, blurHandler] = useInput('');
      ...
      <div className='button-messanger-menu__header'>
        ...
        <div className='button-messanger-menu__panel'>
          <ButtonMessangerPanelItem
            item_help={t('authorized.header.header-right.button-messenger.menu.panel.help-1')}
            help_marginLeft={'-130px'}
            Icon={ZoomOutMapIcon}
            {...props}
          />
          <ButtonMessangerPanelItem
            item_help={t('authorized.header.header-right.button-messenger.menu.panel.help-2')}
            help_marginLeft={'-110px'}
            Icon={VideoCallIcon}
            {...props}
          />
          <ButtonMessangerPanelItem
            item_help={t('authorized.header.header-right.button-messenger.menu.panel.help-3')}
            help_marginLeft={'-80px'}
            Icon={CreateOutlinedIcon}
            {...props}
          />
          <ButtonMessangerPanelItem
            item_help={t('authorized.header.header-right.button-messenger.menu.panel.help-4')}
      ...
      <div className='button-messanger-menu__body'>
        ...
        <div className='button-messanger-menu__searches'>
          {isFocus ? (
            <>
              <span>
                {t('authorized.header.header-right.button-messenger.menu.searches.focused.span-1')}
              </span>
            ...
            <>
              <span>
                {t('authorized.header.header-right.button-messenger.menu.searches.unfocused.span')}
              </span>
              <hr />
              <NavLink
                to={'/messages'}
