  ...
  return (
    <div className={'profile-update-confirm-upload'}>
      ...
      <div className={'profile-update-confirm-upload__description'}>
        <PublicIcon />
        <span>{t('authorized.profile.profile-update-avatar.confirm-upload.description')}</span>
      </div>
      <div className={'profile-update-confirm-upload__buttons-wrapper'}>
        <div className={'profile-update-confirm-upload__buttons'}>
          {props.fetchAvatar ? (
            ...
            >
              <span>
                {t('authorized.profile.profile-update-avatar.confirm-upload.cancel-button')}
              </span>
            </div>
          )}
          {props.fetchAvatar ? (
            <div className={'profile-update-confirm-upload__save-button_disabled'}>
              <span>
                {t('authorized.profile.profile-update-avatar.confirm-upload.save-button')}
              </span>
            </div>
          ) : (
            <div
