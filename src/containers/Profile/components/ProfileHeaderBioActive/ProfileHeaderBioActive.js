...
export const ProfileHeaderBioActive = (props) => {
  ...
  const [textAreaSymbols, setTextAreaSymbols] = useState(props.user === null ? '' : props.user.Bio);
    ...
    <div className={'profile__header__bio__active'}>
      <div className={'profile__header__bio__activeTextarea'}>
        <textarea
          ...
          placeholder={t('authorized.profile.header.active-bio.textarea-placeholder')}
        ></textarea>
      </div>
      ...
      <div className={'profile__header__bio__activePanel'}>
        ...
        <div className={'profile__header__bio__activeButtons'}>
          ...
          >
            <span>{t('authorized.profile.header.active-bio.cancel-button')}</span>
          </div>
