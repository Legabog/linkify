  ...
  return (
    <div className="login-route-wrapper">
      <div className="login-route">
        <div className="login-route__signin-block">
          <div className="login-route__signin-block__logo">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          <div className="login-route__signin-block__description">
            <h2>{t("unauthorized.login-route.description.h2")}</h2>
          </div>
          <div className="login-route__signin-block__description_2">
            <span>{t("unauthorized.login-route.description.span")}</span>
          </div>
          <div className="login-route__error-info-wrapper">
            ...
            >
              ...
              <span>
                {t(
                  "unauthorized.login-route.signin-block.error-info.description"
                )}{" "}
                <NavLink
                  to={"/signup"}
                >
                  {t(
                    "unauthorized.login-route.signin-block.error-info.navLink"
                  )}
                </NavLink>
              </span>
            </div>
          </div>
          <div className="login-route__signin-block__inputs-wrapper">
            <div className="login-route__signin-block__inputs">
              <div className="login-route__signin-block__input">
                <input
                  ...
                  placeholder={t(
                    "unauthorized.login-route.signin-block.login-input"
                  )}
                  autoComplete="off"
                  value={email}
                  ref={emailRef}
          ...
          <div className="login-route__signin-block__restore-password">
            <a href="/">
              {t("unauthorized.login.signin-block.restore-password")}
            </a>
          </div>
          <div className="login-route__signin-block__buttons">
            <div
              className="login-route__signin-block__button-signin"
              onClick={loginButtonSignInHandler}
            >
              <span>{t("unauthorized.login.signin-block.login-button")}</span>
            </div>
            <NavLink to={"/signup"}>
              <div className="login-route__signin-block__button-signup">
                <span>
          ...
          <div className="login-route__signin-block__help">
            <span>
              <NavLink to={"/"}>
