      ...
      {props.fetchFullUserInfoAbout ? (
        ...
        <div className={'OverviewComponent'}>
          <OverviewComponentSection
            ...
            editTitle={t('authorized.about.right-section.component-1.section-1.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-1.section-1.delete-title')}
            title={t('authorized.about.right-section.component-1.section-1.title')}
            Icon={WorkIcon}
            activeInputs={4}
          ...
          <OverviewComponentSection
            ...
            title={t('authorized.about.right-section.component-1.section-2.title')}
            editTitle={t('authorized.about.right-section.component-1.section-2.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-1.section-2.delete-title')}
            Icon={SchoolIcon}
            activeInputs={2}
            ativeInputPlaceholder1={t(
          ...
          <OverviewComponentSection
            ...
            title={t('authorized.about.right-section.component-1.section-3.title')}
            editTitle={t('authorized.about.right-section.component-1.section-3.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-1.section-3.delete-title')}
            Icon={SchoolIcon}
            activeInputs={2}
            ativeInputPlaceholder1={t(
          ...
          <OverviewComponentSection
            ...
            title={t('authorized.about.right-section.component-1.section-4.title')}
            editTitle={t('authorized.about.right-section.component-1.section-4.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-1.section-4.delete-title')}
          ...
          <OverviewComponentSection
            ...
            title={t('authorized.about.right-section.component-1.section-5.title')}
            editTitle={t('authorized.about.right-section.component-1.section-5.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-1.section-5.delete-title')}
          ...
          <OverviewComponentSection
            ...
            title={t('authorized.about.right-section.component-1.section-6.title')}
            editTitle={t('authorized.about.right-section.component-1.section-6.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-1.section-6.delete-title')}
