      ...
      {props.fetchFullUserInfoAbout ? (
        ...
        <div className={'LifeEventsComponent'}>
          <LifeEventsComponentSection
            componentArguments={
              props.fullUserInfoAbout === null ? null : props.fullUserInfoAbout.LifeEvents
            }
            ...
            title={t('authorized.about.right-section.component-7.section.title')}
            titleBold={t('authorized.about.right-section.component-7.section.title-bold')}
            editTitle={t('authorized.about.right-section.component-7.section.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-7.section.delete-title')}
          ...
          {props.fullUserInfoAbout === null ? null : props.fullUserInfoAbout.LifeEvents.length ===
            0 ? (
            <div className={'LifeEventsComponent__section__description'}>
              <EventBusyIcon />
              <span>{t('authorized.about.right-section.component-7.description')}</span>
            </div>
          ) : null}
