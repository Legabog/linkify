      ...
      {props.fetchFullUserInfoAbout ? (
        ...
        <div className={'DetailsAboutYouComponent'}>
          <DetailsAboutYouComponentSection
            ...
            title={t('authorized.about.right-section.component-6.section-1.title')}
            titleBold={t('authorized.about.right-section.component-6.section-1.title-bold')}
            editTitle={t('authorized.about.right-section.component-6.section-1.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-6.section-1.delete-title')}
          ...
          <DetailsAboutYouComponentSection
            ...
            title={t('authorized.about.right-section.component-6.section-2.title')}
            titleBold={t('authorized.about.right-section.component-6.section-2.title-bold')}
            editTitle={t('authorized.about.right-section.component-6.section-2.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-6.section-2.delete-title')}
          ...
          <DetailsAboutYouComponentSection
            ...
            title={t('authorized.about.right-section.component-6.section-3.title')}
            titleBold={t('authorized.about.right-section.component-6.section-3.title-bold')}
            editTitle={t('authorized.about.right-section.component-6.section-3.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-6.section-3.delete-title')}
            Icon={PanoramaFishEyeIcon}
            activeInputs={1}
            ativeInputPlaceholder1={t(
          ...
          <DetailsAboutYouComponentSection
            ...
            title={t('authorized.about.right-section.component-6.section-4.title')}
            titleBold={t('authorized.about.right-section.component-6.section-4.title-bold')}
            editTitle={t('authorized.about.right-section.component-6.section-4.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-6.section-4.delete-title')}
