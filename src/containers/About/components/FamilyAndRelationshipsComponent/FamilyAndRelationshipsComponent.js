      ...
      {props.fetchFullUserInfoAbout ? (
        ...
        <div className={'FamilyAndRelationshipsComponent'}>
          <FamilyAndRelationshipsComponentSection
            ...
            title={t('authorized.about.right-section.component-5.section-1.title')}
            titleBold={t('authorized.about.right-section.component-5.section-1.title-bold')}
            editTitle={t('authorized.about.right-section.component-5.section-1.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-5.section-1.delete-title')}
            Icon={FavoriteIcon}
            activeInputs={1}
          ...
          <FamilyAndRelationshipsComponentSection
            ...
            title={t('authorized.about.right-section.component-5.section-2.title')}
            titleBold={t('authorized.about.right-section.component-5.section-2.title-bold')}
            editTitle={t('authorized.about.right-section.component-5.section-2.edit-title')}
            deleteTitle={t('authorized.about.right-section.component-5.section-2.delete-title')}
            Icon={PersonIcon}
            activeInputs={3}
            ativeInputPlaceholder1={t(
